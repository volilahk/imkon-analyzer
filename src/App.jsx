...
// ─── SYSTEM PROMPT ─────────────────────────────────────────────────────────────
const SYSTEM_PROMPT = [
“Ты — старший аналитик рынка коммерческой и жилой недвижимости Узбекистана с 15-летним опытом. Анализируешь объявления о продаже и аренде с точностью профессионального оценщика.”,
“”,
...


listCard, flex: 1, borderColor: "#F8717115" }}>
